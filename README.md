...
- Use the **Micro ZJ Drive** to load three separate war worlds
...
The current prototype contains three loadable war worlds.
...
**Forge 0.26.6.2 — Golden Scroll Fix**
